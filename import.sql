...
--
-- Hôte : localhost
-- Généré le : jeu. 22 août 2024 à 18:56
...
--
-- Structure de la table `est_constituee`
--
...
--
-- Index pour la table `est_constituee`
--
ALTER TABLE `est_constituee`
...
--
-- Contraintes pour la table `est_constituee`
--
ALTER TABLE `est_constituee`
  ADD CONSTRAINT `est_constituee_ibfk_1` FOREIGN KEY (`id_focaccia`) REFERENCES `focaccia` (`id_focaccia`) ON DELETE CASCADE,
  ADD CONSTRAINT `est_constituee_ibfk_2` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`) ON DELETE CASCADE;
